...
day_df = pd.read_csv('https://raw.githubusercontent.com/garenkosburne/visualisasi_data/day.csv')
day_df.head()
...
with st.sidebar:
    st.image('/content/drive/MyDrive/Tugas Akhir Project Visualisasi Data by Phyton/DKM-04B.png')
...
colors3=["tab:red", "tab:green", "tab:orange", "tab:blue", "tab:purple", "tab:brown", "tab:pink"]
...
st.caption('Copyright (c) Ringga Setiadi 2023')
